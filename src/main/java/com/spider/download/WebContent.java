...
import com.spider.download.helper.DataUtilEx;
import com.spider.utils.Validate;
 ...
 */
public class WebContent implements Connection {
    public static Connection connect(String url) {
        Connection con = new WebContent();
        con.url(url);
        return con;
    }
...
//                            contentType, req.url().toString());
                ...
                try {
                    ...
                    res.byteData = DataUtilEx.readToByteBuffer(bodyStream);
                    res.charset = DataUtilEx.getCharset(res.contentType,res.byteData);
                } finally {
        ...
        public String body() {
            ...
            String body;
            if (charset == null)
                body = Charset.forName(DataUtilEx.defaultCharset).decode(byteData).toString();
            else
        ...
        private static void writePost(Collection<Connection.KeyVal> data, OutputStream outputStream) throws IOException {
            OutputStreamWriter w = new OutputStreamWriter(outputStream, DataUtilEx.defaultCharset);
            boolean first = true;
            for (Connection.KeyVal keyVal : data) {
                ...
                w.write(URLEncoder.encode(keyVal.key(), DataUtilEx.defaultCharset));
                w.write('=');
                w.write(URLEncoder.encode(keyVal.value(), DataUtilEx.defaultCharset));
            }
            w.close();
        }
        ...
        private static void serialiseRequestUrl(Connection.Request req) throws IOException {
            ...
            for (Connection.KeyVal keyVal : req.data()) {
                if (!first)
                    ...
                    first = false;
                url
                    .append(URLEncoder.encode(keyVal.key(), DataUtilEx.defaultCharset))
                    .append('=')
                    .append(URLEncoder.encode(keyVal.value(), DataUtilEx.defaultCharset));
            }
